...
class getRequestHandlerTest {
    ...
    void getHotelsByAirportIDValuesTest() {
        ...
        JSONObject [] responseKeys = hotelTest.getApiResponseResults();
        assertEquals("[{\"price\":70,\"extendedDataInJSON\":\"{}\",\"autoID\":1," +
                        "\"name\":\"Trump Hotels\",\"liaison\":27,\"isActive\":1," +
                        "\"airport\":6}, {\"price\":70,\"extendedDataInJSON\":\"{}" +
                        "\",\"autoID\":7,\"name\":\"test3\",\"liaison\":27,\"isActive\":1,\"airport\":6}]", Arrays.toString(responseKeys));
    }
    @Test
    void getBookingByID(){
        ...
        assertEquals("[{\"departureTime\":\"2018-10-30 14:00:00\"," +
                        "\"arrivalTime\":\"2018-10-30 15:00:00\"," +
                        "\"extendedDataInJSON\":\"None\"," +
                        "\"autoID\":\"1\"," +
                        "\"passengerID\":\"1\"," +
                        "\"flightID\":\"1\"," +
                        "\"isActive\":\"1\"}]", Arrays.toString(responseKeys));
    }
}