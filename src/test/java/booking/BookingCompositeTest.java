...
class BookingCompositeTest {
    BookingComposite testBooking;
    @BeforeEach
    void setUp() {
        testBooking = new BookingComposite();
        FlightBooking testFlightBooking =
                new FlightBooking(
                        new Route(
                                new Airport(0, "test"),
                                new Airport(1, "test"),
        ...
        testBooking.addChildBooking(testFlightBooking);
    }
